...
const TimeProgressContainer1 = ({ propLeft, propBackgroundImage, propTop }) => {
  ...
  return (
    <div
      className="absolute top-[calc(50%_-_130.5px)] left-[calc(50%_+_386.5px)] rounded-xl w-[260px] h-[350px] bg-[url('/public/frame-1000003703@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-3xs text-black1 font-inter"
...
export default TimeProgressContainer1;
